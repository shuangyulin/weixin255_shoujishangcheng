    ...
    >  
     <el-row>
                              ...
                              <el-form-item v-if="flag=='yonghu'"  label='用户姓名' prop="yonghuName">
                                  <el-input v-model="ruleForm.yonghuName" readonly  placeholder='用户姓名' clearable></el-input>
                              </el-form-item>
                          </el-col>
                        ...
                        <el-col :span="24">
                          ...
                          <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='用户手机号' prop="yonghuPhone">
                                  <el-input v-model="ruleForm.yonghuPhone" readonly  placeholder='用户手机号' clearable></el-input>
                              </el-form-item>
                          </el-col>

                          <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='用户身份证号' prop="yonghuIdNumber">
                                  <el-input v-model="ruleForm.yonghuIdNumber" readonly  placeholder='用户身份证号' clearable></el-input>
                              </el-form-item>
                          </el-col>

                          <el-col :span="12">
                              <el-form-item v-if="flag=='yonghu'"  label='余额' prop="newMoney">
                                  <el-input v-model="ruleForm.newMoney" readonly  placeholder='余额' clearable></el-input>
                              </el-form-item>
                          </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.newMoney)&& 'yonghu'==this.flag){
