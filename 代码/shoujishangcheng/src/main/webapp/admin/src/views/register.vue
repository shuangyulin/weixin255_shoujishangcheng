    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">手机商城注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="密码" class="input">
                            <el-input v-model="ruleForm.password" autocomplete="off" placeholder="密码"  />
                        </el-form-item>
                        <el-form-item label="重复密码" class="input">
                            <el-input v-model="ruleForm.repetitionPassword" autocomplete="off" placeholder="重复密码"  />
                        </el-form-item>
